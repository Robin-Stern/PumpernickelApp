...
- [ ] 21-06-PLAN.md — B6: XP-bookkeeping at unranked state — verify-first with logs across GamificationEngine + RankLadder + OverviewViewModel, then UI/doc update or real engine fix (D-21-07)
