...
- [x] 04-02-PLAN.md — WorkoutHistoryViewModel, SettingsViewModel, WorkoutSessionViewModel previous performance, Koin DI wiring
- [x] 04-03-PLAN.md — iOS SwiftUI history list, detail, settings views, previous performance display, global unit integration
